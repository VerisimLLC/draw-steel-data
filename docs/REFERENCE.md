...
| File | Contents |
|------|----------|
| [reference/CORE.md](reference/CORE.md) | Common pitfalls, table names, GoblinScript booleans, UUID reference maps (action resources, conditions, ongoing effects, damage types, characteristics, keywords, custom attributes, standard abilities), import workflow, ASCII-only rule |
